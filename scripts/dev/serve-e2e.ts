...
const CORPUS: Record<string, string> = {
  ...
  'docs/adr/0001-bun-workspace-monorepo.md': '# ADR 0001\n',
};
      ...
      retrievalResults: [
        {
          ...
          location: { s3Location: { uri: 's3://corpus/docs/adr/0001-bun-workspace-monorepo.md' } },
          score: 0.88,
        },
      ],
    }),
...
const app = createApp({
  corpus: new CorpusClient({ s3: stubS3, bucket: 'e2e-corpus', prefix: PREFIX }),

...
export default tseslint.config(
  {
    ignores: [
      ...
      // Generated by scripts/build/build-publisher.ts — a vendored bundle and a minified shim.
      // Linting either says nothing about code anyone here writes.
      'apps/docs/static/publisher/*.js',
    ],
  },
